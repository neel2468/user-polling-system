...
import {
    MAX_CHOICES,POLL_QUESTION_MAX_LENGTH,POLL_CHOICE_MAX_LENGTH
...
class NewPoll extends Component {
    ...
    handleSubmit = () => {
        ...
        .then(response => {
            ...
            if(error.status === 401) {
                this.props.handleLogout('/login','error','You have been logged out. Please login to create poll.');
            } else {
                notification.error({
                    message: 'Polling App',
